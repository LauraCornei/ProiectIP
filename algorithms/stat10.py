...
def main_hours(orders):
    ...
    ax.set(xlabel='Time of order (hours)', ylabel='No of customers ', title='Stat 10')
    ax.grid()
    return fig
...
def main_half_hours(orders):
    ...
    ax.set(xlabel='Time of order (30 min)', ylabel='No of customers ', title='Stat 10')
    ax.grid()
    return fig
...
def main_min(orders):
    ...
    ax.set(xlabel='Time of order (min)', ylabel='No of customers ', title='Stat 10')
    ax.grid()
    return fig
